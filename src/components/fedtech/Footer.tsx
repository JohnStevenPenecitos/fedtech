...
export function Footer() {
  return (
    <footer className="footer-reveal bg-footer text-footer-foreground">
      <div className="site-container py-14">
        <div className="grid gap-10 border-b border-footer-border pb-10 md:grid-cols-[1fr_auto]">
          <div>
            <BrandMark inverse />
            <p className="mt-4 max-w-sm text-sm leading-6 text-footer-muted">
              Leading Tech Horizons, One Solution at a Time.
            </p>
          </div>
          <nav
        ...
        <div className="flex flex-col gap-5 pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-footer-muted">
            Copyright © 2026 Fedtech - All Rights Reserved.
          </p>
          <div className="flex gap-3">
            <a className="social-link" href="https://facebook.com" aria-label="Facebook">
              <Facebook />
            </a>
            <a className="social-link font-bold" href="https://x.com" aria-label="X">
              X
            </a>
